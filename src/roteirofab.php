         ...
         <hr>
            <form action="cadastro-roteiro.php" method="POST" enctype="multipart/form-data" name="upload">
              ...
              <div class="form-group col-md-3">
                  <label>Roteiro:</label>
                  <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="c_roteiro" placeholder="Digite roteiro" required/>
                </div>
                <hr>
                <div class="form-group col-md-3">
                  <label>Descrição:</label>
                  <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="c_descr" placeholder="Digite descrição roteiro" required/>
                </div>
                <div class="form-group col-md-3">
                  <label>Operação:</label>
                  <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="c_oper" placeholder="Digite operação" required>
                </div>    
                  <hr>
                  <div class="form-group col-md-3">
                    <label>Centro de Trabalho:</label>
                    <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="c_trab" placeholder="Digite centro trabalho" required>
                  </div>      
                  <div class="form-group col-md-3">
                    <label>Arranjo Fisico:</label>
                    <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="c_arranjo" placeholder="Digite arranjo fisico" required>
                  </div>      
                  <div class="form-group col-md-2">
                    <label>Centro de Custo:</label>
                    <select  name="c_custo" class="form-control form-control-sm col-md-10 col-sm-10" placeholder="Digite centro de custo" required>
