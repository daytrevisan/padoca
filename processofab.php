            ...
            <form action="cadastro-processo.php" method="POST" enctype="multipart/form-data" name="upload">
              <div class="row">
                ...
                <div class="form-group col-md-3">
                  <label>Produto:</label>
                  <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="c_prod" placeholder="Digite codigo produto" required/>
                </div>
                <div class="form-group col-md-3">
                  <label>Roteiro:</label>
                  ...
                  <div class="form-group col-md-3">
                    <label>Tempo Médio Oper.:</label>
                    <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="c_tempo" placeholder="Digite tempo médio" required>
                  </div>      

                  <div class="form-group col-md-3">
                    <label>Valor Oper.:</label>
                    <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="c_valor" placeholder="Digite valor oper." required>
                  </div>      
                  <hr>
                  <div class="row">
